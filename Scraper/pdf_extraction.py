...
def find_similar(string_, compare_values_, use_cosine=True, use_weights=True):
	highest_match = {
		"str": "",
		"cat": "",
		"match": "",
	...
	similarity_list = []
	for compare_name in compare_values_["compare"]:
		item = compare_values_[compare_name]
...
class DocPage:
	...
	def extract_data(self):
		...
		for table_area in table_areas:
			...
			if around_bottom[2] - around_bottom[0] > 1 and around_bottom[3] - around_bottom[1] > 1:
